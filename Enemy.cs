...
namespace PracticeApp
{
    class Enemy
    {
        ...
        private static Character CreateEnemy(string enemyName, int health, int attackPower, int defence)
        {
            Character newEnemy = new Character(enemyName, health, attackPower, defence);
            return newEnemy;
        }

        public static Character CreateSmallRobot(){
            return CreateEnemy("Small Robot", 10, 5, 2);
        }
